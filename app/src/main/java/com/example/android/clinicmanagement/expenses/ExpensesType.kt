...
enum class ExpensesType(val number: Int, @StringRes val stringResource: Int, @DrawableRes val iconResource:Int,@ColorRes val colorRes: Int) {
    UTILITIES(1, R.string.utilities, R.drawable.ic_expenditure_receipt,R.color.expenses_imperial_red),
    ...
    TAX(6, R.string.tax, R.drawable.ic_expenditure_tax,R.color.expenses_zomp),
    SUPPLIES(7, R.string.supplies, R.drawable.ic_expenditure_medical_supplies,R.color.expenses_egyptian_blue),
    DIVERS(8, R.string.divers, R.drawable.ic_expenditure_divers,R.color.expenses_persian_indigo);
